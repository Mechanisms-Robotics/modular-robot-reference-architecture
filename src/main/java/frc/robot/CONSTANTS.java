...
public class CONSTANTS {
    ...
    public static final long SWERVE_ENCODER_SET_FREQUECY_SECONDS = 1;
    ...
    public static final double DRIVE_MOI = 0.075;
    public static final double DRIVE_GEAR_RATIO = 5.9;
    public static final double TURN_MOI = 0.075;
    public static final double LOOP_PERIOD_SECS = 0.02;
    public static final double TURN_CURRENT_LIMIT_AMPS = 30.0;
